...
When we released the first version of cosmOS last year, it was written in Go. Go is a wonderful programming language with a lot of benefits. However, in the ever-evolving landscape of technology, it's important to explore different approaches that might bring even more advantages. One such approach that has gained significant attention recently is event-driven architecture.
