    ...
    <li className="flex gap-4">
      ...
      <dl className="flex flex-auto flex-wrap gap-x-2">
        ...
        <dd className="w-full flex-none text-sm font-medium text-zinc-900 dark:text-zinc-100">
          <a href={role.url} target='__blank'>{role.company}</a>
        </dd>
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <div className="mt-6 flex gap-6">
            <SocialLink
              href="https://twitter.com/AldonIsenbergII"
              aria-label="Follow on Twitter"
              icon={TwitterIcon}
            />
            <SocialLink
              href="https://www.instagram.com/isenbergii/"
              aria-label="Follow on Instagram"
              icon={InstagramIcon}
            />
            <SocialLink
              href="https://github.com/AldonIsenberg11"
              aria-label="Follow on GitHub"
              icon={GitHubIcon}
            />
            <SocialLink
              href="https://www.linkedin.com/in/aldon-isenberg-ii-137242115/"
